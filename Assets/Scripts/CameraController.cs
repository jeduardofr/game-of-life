...
{
    [SerializeField] private Transform m_Player, m_PlayerCamera, m_FocusPoint;

    [SerializeField] private float m_Zoom = -12;

    [SerializeField] private float m_ZoomSpeed = 3;

    [SerializeField] private float m_ZoomMax = -0.5f, m_ZoomMin = -10f;

    [SerializeField] private float m_CameraHeight = 4f;

    [SerializeField] private float m_CamRotX, m_CamRotY;
